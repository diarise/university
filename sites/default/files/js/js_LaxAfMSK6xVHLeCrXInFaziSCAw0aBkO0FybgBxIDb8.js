...
(function($) {
	...
	function showDD() {	
		if (!$.browser.opera) {
			$('#lessonCollectionSection form select,.transcription select,#teachings_teachersDD,#teachings_topicDD').each(function(){
	...
	$(document).ready(function(){
		$("#lessonCollectionSection tr").hover(
			function(){
                ...
                $(this).find(".views-field-twistage-subtitles span").css({
...
jQuery(window).load(function($) {
    (function ($) {
        ...
        function getScrollbarWidth() {
            ...
            var div = $('<div style="width:50px;height:50px;overflow:hidden;position:absolute;top:-200px;left:-200px;"><div style="height:330px;"></div></div>');
            $('body').append(div);
        ...
        $.fn.tableScroll.defaults = {
            ...
            height: 330, // height of the scrollable area
    ...
    jQuery(document).ready(function ($) {
        $('#lessonCollectionSection .views-table').tableScroll({
            Height: 330
        });
...
(function($){
 ...
 $(document).ready(function(){
        ...
        $.each($("#block-ukabbalah-courses-by-parent-courses-grid-view li"), function(){
...
(function($) {
  $(document).ready(function() {
    ...
    $('#block-system-main .view-content').masonry({
      itemSelector: '#block-system-main .view-content div.views-row',
      isFitWidth: true ,
      animationOptions: {
        duration: 400
      }
    ...
    $('#block-ukabbalah-courses-by-parent-courses-grid-view ul').masonry({
      itemSelector: '#block-ukabbalah-courses-by-parent-courses-grid-view ul li',
      isFitWidth: true ,
      animationOptions: {
        duration: 400
      }
...
Drupal.behaviors.alter_flag_links = {
  attach: function(context) {
    ...
    jQuery('span.flag-wrapper').each(function() {
