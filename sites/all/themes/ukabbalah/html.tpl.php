...
<head>
  	...
  	<meta name="description" content="<?php if (isset($head_image)) { echo strip_tags($head_desc); } else{ echo "Kabbalah University is an powerful tool for spiritual connection, study and supporting a community of thousands of students around the world achieve greater spiritual growth through the wisdom of Kabbalah."; } ?>" />
  	<meta property="og:title" content="<?php print $head_title; ?>" />
  	<meta property="og:description" content="<?php if (isset($head_image)) { echo strip_tags($head_desc); } else{ echo "Kabbalah University is an powerful tool for spiritual connection, study and supporting a community of thousands of students around the world achieve greater spiritual growth through the wisdom of Kabbalah."; } ?>" />
