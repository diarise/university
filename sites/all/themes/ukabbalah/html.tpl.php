...
<!-- this popup show up only when the user is not log in -->
			...
			<?php } else {?>
				<div id="popupNotLogin">Welcome to the Kabbalah University please <a href="http://idp.kabbalah.com/user/login">login</a> or <a href="http://idp.kabbalah.com">sign up</a> to have access to the videos <span>X</span></div>
			<?php }?>
	...
	<div id="headerSearch">
		...
		<div id="usersessionsession">
			...
			<div class="usersessionsession">
				...
				<a href="http://idp.kabbalah.com/user" class="activeLink"><?php print $username; ?></a><span class="pipe">|</span><a href="/user/logout">Log Out</a>
			<?php } else {?>
				<a href="http://idp.kabbalah.com/user/login" class="activeLink">Log In</a><span class="pipe">|</span><a href="http://idp.kabbalah.com">Signup</a>
			<?php }?>
			</div>
		</div>
	</div>
