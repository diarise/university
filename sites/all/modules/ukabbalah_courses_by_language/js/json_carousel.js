                ...
                startPoint = function(){                    
                    ...
                    $.each(globalData,function(headObj, headObjCont){
                        ...
                        rowContent += "<div id = " + headObj[0]+ headObj[1] + headObj[2] + " class = 'rowStyle'" + ">"
                                        + "<img class='leftArrowStyleHome' src='/sites/all/modules/ukabbalah_courses_by_language/images/arrow-left.png'/>"
                        ...
                        rowContent += "</ul>" + "</div>"+ "<img class='rightArrowStyleHome' src='/sites/all/modules/ukabbalah_courses_by_language/images/arrow-right.png'/>"  + "</div>" ;
                    });
